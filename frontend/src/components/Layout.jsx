    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
          ...
          <button type="button" className="lg:hidden text-gray-500" onClick={() => setSidebarOpen(false)} aria-label="Close menu">
            <X size={20} />
          </button>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-white border-b border-gray-200 flex items-center px-6 lg:hidden">
          <button type="button" onClick={() => setSidebarOpen(true)} className="text-gray-600" aria-label="Open menu">
            <Menu size={24} />
          </button>
